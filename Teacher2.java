...
String Department;
int Teacher_id;
Teacher2(String name,String gender,String address,int age,int emp_id,String companyname,String qualification,int salary,String subject,String department,int teacherid)
{
...
arr[i]=new Teacher2(Name,Gender,Address,Age,Emp_id,Companyname,Qualification,Salary,Subject,Department,Teacher_id);
}
sc.close();
